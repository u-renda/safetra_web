...
|
*/
$config['encryption_key'] = 'adDOt48J';
...
$config['sess_cookie_name'] = 'ci_safetra';
...
$config['safetra_address'] = 'Jl. W.R. Supratman no. 10B Kampung Utan, Cemp. Putih, Ciputat, Kota Tangerang Selatan, Banten 15412';
...
$config['link_article'] = $config['base_url'].'media/article_lists';
$config['link_article_detail'] = $config['base_url'].'media/article_detail/';
$config['link_contact_us'] = $config['base_url'].'contact_us';
$config['link_login'] = $config['base_url'].'login';
$config['link_gallery'] = $config['base_url'].'media/gallery';
$config['link_lowongan'] = $config['base_url'].'lowongan';
