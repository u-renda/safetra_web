<section class="page-header page-header-color page-header-tertiary page-header-more-padding mb-none">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Hubungi Kami</h1>
...
<section class="section m-none">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2><strong>PT. SAFETRA INDONESIA</strong></h2>
                <ul class="list list-icons list-icons-style-3 mt-xlg">
                    ...
                    <li><i class="fa fa-phone"></i> <strong>Telp:</strong> <?php echo $this->config->item('safetra_phone').' | '.$this->config->item('safetra_phone2'); ?></li>
